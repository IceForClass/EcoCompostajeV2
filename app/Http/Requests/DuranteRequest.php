    ...
    public function storeRules(): array
{
    return [
        ...
        'cantidad_aporteVLitros' => 'nullable|numeric|min:0|max:99.99',
        'cantidad_aporteVKilos' => 'nullable|numeric|min:0|max:99.99',
        'tipo_aporteV' => 'nullable|string|max:255',
        'aporte_seco' => 'nullable|boolean',
        'cantidad_aporteSLitros' => 'nullable|numeric|min:0|max:99.99',
        'cantidad_aporteSKilos' => 'nullable|numeric|min:0|max:99.99',
